...
// EMAIL_FROM is the production From address for email sign-in (a committed var,
// narrowed to its literal by cf-typegen, so widened to string here). Optional:
// local/e2e use the fake email seam, and its absence in production fails sign-in
// email closed (503) via makeEmailSender. The EMAIL send_email binding itself is
// generated by cf-typegen (declared in wrangler.jsonc, omitted in e2e).
