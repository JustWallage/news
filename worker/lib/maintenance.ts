...
import { purgeExpiredCodes } from "./email-login";
...
// Delete sessions and email sign-in codes past their TTL, and clear Telegram link
// codes past their expiry. Expired rows are already ignored at lookup/consume/
// verify time; this just stops them piling up. Telegram rows are NOT deleted —
// only the stale code fields are cleared, so a linked chat (timezone, slots)
// survives.
